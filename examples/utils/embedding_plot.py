"""Generic embedding visualization utilities.

This module provides reusable functions for computing and visualizing embeddings
from autoencoder models. It can be used by different examples with dataset-specific
wrappers.
"""
